...
if( ! function_exists( 'reverie_scripts_and_styles ' ) ) {
	function reverie_scripts_and_styles() {
	  if (!is_admin()) {
		...
		// Other JS Files
		wp_register_script( 'TweenMax', get_template_directory_uri() . '/bower_components/gsap/TweenMax.min.js', array( 'jquery' ), '', true );
		wp_register_script( 'iscroll', get_template_directory_uri() . '/bower_components/scrollmagic/_mobile/iscroll-probe.js', array( 'jquery' ), '', true );
		wp_register_script( 'scrollmagic', get_template_directory_uri() . '/bower_components/scrollmagic/jquery.scrollmagic.min.js', array( 'jquery' ), '', true );
		wp_register_script( 'ScrollToPlugin', get_template_directory_uri() . '/bower_components/gsap/plugins/ScrollToPlugin.min.js', array( 'jquery' ), '', true );
		wp_register_script( 'scrollmagic-debug', get_template_directory_uri() . '/bower_components/scrollmagic/jquery.scrollmagic.debug.js', array( 'jquery' ), '', true );
		//register slick slider
		wp_register_script( 'slick-slider', get_template_directory_uri() . '/bower_components/slick/slick.min.js', array( 'jquery' ), '', true );
